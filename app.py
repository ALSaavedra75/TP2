...
class Producto(db.Model):
    ...
    def __init__(self,nombre,fecha,dni,imagen):
        self.nombre = nombre
        self.fecha = fecha
        self.dni = dni
        self.imagen = imagen
...
class ProductoSchema(ma.Schema):
    class Meta:
        fields=('id','nombre','fecha','dni','imagen')
...
def create_producto():
    ...
    new_producto=Producto(nombre,fecha,dni,imagen)
...
def update_producto(id):
    ...
    producto.fecha=request.json['fecha']
